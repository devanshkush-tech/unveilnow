...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Contact Unveil Now | Get in Touch"
        description="Reach the Unveil Now team for account support, feedback, partnerships, press, safety concerns, or technical issues."
        path="/contact"
      />
      <Navbar />
