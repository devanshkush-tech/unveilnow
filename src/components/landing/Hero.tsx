  ...
  return (
    <section className="relative pt-28 md:pt-36 pb-20 md:pb-32 overflow-hidden">
      ...
      <div className="container max-w-5xl text-center">
        ...
        <p className="mt-7 text-base md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-up delay-100">
        ...
        <p className="mt-8 text-sm text-muted-foreground animate-fade-up delay-300">
          Free to join · Verified profiles · Built for serious relationships
        </p>
      </div>
    </section>
  );
